---
name: gsd-spec-phase
description: "Esclarecer O QUE uma fase entrega com pontuação de ambiguidade; produz um SPEC.md antes de discuss-phase."
---
...
<process>
Execute the spec-phase workflow from @.agent/get-shit-done/workflows/spec-phase.md end-to-end.
