---
name: gsd-update
description: "Atualizar o GSD para a versão mais recente com exibição de changelog"
---
...
- Otherwise: **Follow the update workflow** from `@.agent/get-shit-done/workflows/update.md`.
