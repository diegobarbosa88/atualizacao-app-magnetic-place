      ...
      <div className="space-y-2 sm:space-y-4">
        ...
        {showComments ? (
          <div className="space-y-0.5 sm:space-y-1 animate-in fade-in slide-in-from-top-2">
            ...
            <textarea rows="2" placeholder="Opcional: Preencha notas ou detalhes sobre a tarefa..." className="w-full bg-slate-50 border border-slate-200 rounded-lg sm:rounded-xl p-2 sm:p-3 text-sm outline-none resize-none shadow-inner text-slate-900" value={data.description || ''} onChange={(e) => onChange({ ...data, description: e.target.value })} />
          </div>
        ) : (
          <div>
