            ...
            {burstResultados ? (
              <>
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 bg-[var(--orange)] text-[var(--navy-solid)] rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-[var(--orange-hover)] transition-all shadow-sm shadow-[var(--orange-shadow)] disabled:opacity-40 disabled:cursor-not-allowed">
