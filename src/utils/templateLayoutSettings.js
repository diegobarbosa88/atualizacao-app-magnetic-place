...
export const DEFAULT_LAYOUT_SETTINGS = {
  ...
  // useDocumentTemplates.js, afetam a chamada à PDF.co (margin/paperSize),
  // não uma regra CSS. Ficam aqui só para teres um único sítio com os
  // valores por omissão.
  headerMarginPx: 76,
  footerMarginPx: 34,
};
...
// marca os que afetam o <style> aditivo (refletem-se no preview ao vivo);
// os outros só se veem no PDF final aprovado.
export const LAYOUT_SETTING_FIELDS = [
  ...
  { key: 'headerMarginPx', label: 'Margem do cabeçalho (só no PDF final)', css: false },
  { key: 'footerMarginPx', label: 'Margem do rodapé (só no PDF final)', css: false },
];
