      ...
      footer={
        <div className="flex gap-2 px-6 py-4">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[var(--orange)] text-[var(--navy)] rounded-xl hover:bg-[var(--orange-deep)] transition-all text-[10px] font-black uppercase tracking-widest disabled:opacity-40 disabled:cursor-not-allowed"
          >
            ...
            {showNovaTag ? (
              <div className="flex items-center gap-2 w-full mt-1 p-3 bg-slate-50 rounded-2xl border border-slate-200">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-1.5 bg-[var(--orange)] text-[var(--navy)] rounded-xl text-[10px] font-black uppercase tracking-widest disabled:opacity-40 hover:bg-[var(--orange-deep)] transition-all"
                >
