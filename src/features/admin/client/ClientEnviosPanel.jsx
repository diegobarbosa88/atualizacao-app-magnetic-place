                    ...
                    <div className="flex items-center justify-end gap-1">
                      {c.status === 'validado' ? (
                        <>
                          ...
                          <button onClick={() => setPrintingReport({ client: c, logs, workers, clients, month: portalMonthStr, clientApprovals })} className="p-1.5 rounded-lg hover:bg-[var(--surface-dim)] transition-all" style={{ color: FT.slate }} title="Relatório"><Download size={13} /></button>
                        </>
                      ) : (
