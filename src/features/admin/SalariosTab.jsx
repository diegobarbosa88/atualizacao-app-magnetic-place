...
export default function SalariosTab({ month }) {
            ...
            footer={
              <div className="px-5 py-4 flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  style={sepaModo === 'instant' ? {} : { backgroundColor: FT.navy }}
                >
 ...
 className="flex items-center gap-1.5 px-4 py-2 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl text-xs font-black uppercase tracking-widest transition-colors hover:opacity-90"
