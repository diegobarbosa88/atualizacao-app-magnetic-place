              ...
              <div className="flex gap-2">
                ...
                {inviteEmail && (
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg text-xs font-black uppercase transition-all ${inviteEmailSent ? 'bg-emerald-100 text-emerald-700' : 'bg-[var(--orange)] text-[var(--navy)] hover:bg-[var(--orange-deep)]'} disabled:opacity-60`}
                  >
