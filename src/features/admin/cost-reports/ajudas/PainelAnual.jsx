...
export default function PainelAnual({ ano, orcamentoAnual, jaFaturadoYTD, saldoDisponivel, mesesRestantes, ajudasEfetivoMes, eEstimativa, semHoras, progressoPct }) {
