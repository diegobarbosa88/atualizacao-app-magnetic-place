              ...
              <div key={`${m.month}-${index}`} className="px-4 py-3 space-y-2">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  {!isMatch && !isJustified && (
                    <button
                      onClick={() => onJustificar({ employee_name: employee.employee_name, month: m.month, balance: m.balance })}
                      className="flex items-center gap-1 px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest bg-[var(--surface-dim)] hover:bg-[var(--border)] transition-colors flex-shrink-0" style={{ color: FT.slate }}
                    >
