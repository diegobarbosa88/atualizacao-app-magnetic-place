        ...
        footer={
          <div className="p-4 border-t border-slate-100">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 bg-[var(--orange)] text-[var(--navy)] rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-[var(--orange-deep)] transition-all disabled:opacity-50"
            >
