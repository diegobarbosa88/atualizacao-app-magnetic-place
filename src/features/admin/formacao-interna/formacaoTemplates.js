...
// Ilustrações do e-learning: nome de ícone (ver formacaoIcons.js) em vez de
// foto — cada secção/pergunta tem um ícone próprio e nenhum se repete
// dentro do conjunto das 6 formações e-learning predefinidas.
...
export const CAMPOS_POR_TIPO = {
  ...
  'Segurança em Trabalhos de Soldadura': {
    ...
    questionario: [
      { pergunta: 'Qual o EPI obrigatório para soldadura TIG em espaço fechado?', opcoes: ['Apenas luvas de proteção térmica', 'Máscara de soldar, luvas térmicas e proteção respiratória adicional', 'Apenas óculos de sol', 'Nenhum EPI adicional é necessário'], resposta_correta: 1, icone: 'Glasses' },
      { pergunta: 'O que fazer em caso de exposição prolongada a fumos de soldadura?', opcoes: ['Continuar o trabalho normalmente', 'Reportar sintomas e afastar-se para zona ventilada', 'Ignorar, é normal', 'Aumentar o ritmo de trabalho para terminar mais depressa'], resposta_correta: 1, icone: 'CloudFog' },
      { pergunta: 'Qual a distância mínima recomendada de materiais inflamáveis durante trabalho a quente?', opcoes: ['1 metro', '3 metros', '10 metros (ou conforme procedimento do cliente)', 'Não há distância mínima'], resposta_correta: 2, icone: 'Ruler' },
      { pergunta: 'A máscara de soldar protege também contra a inalação de fumos?', opcoes: ['Verdadeiro', 'Falso'], resposta_correta: 1, icone: 'CircleCheck' },
      { pergunta: 'A quem se deve reportar um quase-acidente?', opcoes: ['A ninguém, não houve ferimentos', 'Ao responsável direto, sempre', 'Só se houver testemunhas', 'Apenas em reunião mensal'], resposta_correta: 1, icone: 'MessageSquare' },
    ],
  },
  'Segurança em Trabalhos de Caldeiraria': {
    duracao_horas: 0.5,
    ...
    nota_minima_aprovacao: 70,
    questionario: [
      { pergunta: 'Qual o EPI obrigatório ao operar uma guilhotina?', opcoes: ['Apenas luvas', 'Luvas anticorte, calçado de proteção e óculos/viseira', 'Nenhum, a máquina já é segura', 'Apenas proteção auditiva'], resposta_correta: 1, icone: 'Scissors' },
      { pergunta: 'Porque é que nunca se deve remover um resguardo de segurança de uma máquina?', opcoes: ['Porque é proibido por regulamento interno apenas', 'Porque expõe diretamente o trabalhador ao risco de esmagamento/entalamento', 'Não há problema em removê-lo temporariamente', 'Só é relevante em máquinas antigas'], resposta_correta: 1, icone: 'ShieldAlert' },
      { pergunta: 'Quando se deve usar ajuda mecânica em vez de levantamento manual?', opcoes: ['Nunca, é sempre mais rápido à mão', 'Sempre que o peso ou dimensão da peça o justificar', 'Só se houver ponte rolante disponível na hora', 'Apenas para peças acima de 100 kg, nunca abaixo'], resposta_correta: 1, icone: 'ArrowUpDown' },
      { pergunta: 'O bloqueio/etiquetagem (LOTO) só é necessário para reparações grandes?', opcoes: ['Verdadeiro', 'Falso — aplica-se a qualquer intervenção, mesmo breve'], resposta_correta: 1, icone: 'Unlock' },
      { pergunta: 'Qual o procedimento em caso de lesão músculo-esquelética aguda no posto de trabalho?', opcoes: ['Forçar o movimento para "desentortar"', 'Não forçar, imobilizar e procurar assistência médica', 'Continuar a trabalhar até ao fim do turno', 'Aplicar apenas gelo e ignorar'], resposta_correta: 1, icone: 'PersonStanding' },
    ],
  },
  'EPI para Soldadura': {
    duracao_horas: 1,
    ...
    conteudo_estruturado: {
      ...
      seccoes: [
        { titulo: 'Introdução', icone: 'Shirt', paragrafos: ['O EPI é a última linha de defesa contra os riscos da soldadura — radiação, calor, projeções e fumos. Tem de ser adequado ao processo utilizado e usado sempre, sem exceções.'] },
        { titulo: 'Máscara e Viseira', icone: 'ShieldCheck', lista: [
        ...
        { titulo: 'Luvas e Vestuário', icone: 'Hand', lista: [
          'Luvas de proteção térmica, resistentes a calor e projeções.',
          'Avental de couro ou roupa ignífuga.',
          'Roupa de manga comprida, sem partes soltas ou inflamáveis.',
        ]},
        { titulo: 'Proteção Respiratória e Auditiva', icone: 'EarOff', lista: [
          'Proteção respiratória adicional em espaços confinados ou ao soldar materiais especiais (galvanizados, inox).',
          'Proteção auditiva quando o nível de ruído do posto o justificar.',
        ]},
        { titulo: 'Regras de Uso e Manutenção', icone: 'Wrench', lista: [
    ...
    questionario: [
      { pergunta: 'Quando deve ser substituído o vidro de proteção da máscara de soldar?', opcoes: ['Nunca precisa de substituição', 'Quando estiver riscado ou danificado', 'Só uma vez por ano, independentemente do estado', 'Só se partir completamente'], resposta_correta: 1, icone: 'Search' },
      { pergunta: 'Que tipo de luvas é obrigatório usar na soldadura?', opcoes: ['Luvas de látex finas', 'Luvas de proteção térmica', 'Luvas de jardinagem', 'Não é obrigatório usar luvas'], resposta_correta: 1, icone: 'HandMetal' },
      { pergunta: 'Quando é necessária proteção respiratória adicional?', opcoes: ['Nunca é necessária', 'Em espaços confinados ou ao soldar materiais especiais (galvanizados/inox)', 'Só se o soldador quiser', 'Só em dias de chuva'], resposta_correta: 1, icone: 'Fan' },
      { pergunta: 'O EPI deve ser inspecionado antes de cada utilização?', opcoes: ['Verdadeiro', 'Falso'], resposta_correta: 0, icone: 'ClipboardCheck' },
      { pergunta: 'Onde deve ser guardado o EPI quando não está a ser usado?', opcoes: ['Em qualquer lugar', 'Em local limpo e seco', 'No chão da oficina', 'Não importa'], resposta_correta: 1, icone: 'Warehouse' },
    ],
  },
  'Ventilação e Extração de Fumos': {
    duracao_horas: 1,
    ...
    conteudo_estruturado: {
      ...
      seccoes: [
        { titulo: 'Introdução', icone: 'GaugeCircle', paragrafos: ['Os fumos de soldadura contêm partículas metálicas e gases nocivos. A exposição prolongada tem efeitos respiratórios a curto e longo prazo, mesmo quando não há sintomas imediatos.'] },
        { titulo: 'Ventilação Geral vs. Extração Localizada', icone: 'DoorOpen', lista: [
        ...
        { titulo: 'Sinais de Exposição Excessiva', icone: 'Skull', lista: [
          'Tonturas.',
          'Irritação nas vias respiratórias.',
          'Dores de cabeça.',
          'Tosse persistente.',
        ]},
        { titulo: 'Boas Práticas', icone: 'ClipboardList', lista: [
          'Confirmar que o sistema de extração está ligado e a funcionar antes de iniciar o trabalho.',
    ...
    questionario: [
      { pergunta: 'A ventilação geral do espaço é suficiente sozinha para proteger contra fumos de soldadura?', opcoes: ['Verdadeiro', 'Falso — precisa de extração localizada'], resposta_correta: 1, icone: 'CircleX' },
      { pergunta: 'Qual destes é um sinal de exposição excessiva a fumos de soldadura?', opcoes: ['Sensação de fome', 'Tonturas e dores de cabeça', 'Sono profundo à noite', 'Nenhum sintoma existe'], resposta_correta: 1, icone: 'ThermometerSun' },
      { pergunta: 'Como te deves posicionar em relação ao fluxo de ar de extração?', opcoes: ['De forma a que o fumo vá para a tua zona respiratória', 'De forma a que o fluxo afaste o fumo da tua zona respiratória', 'Não importa a posição', 'De costas para a peça, sempre'], resposta_correta: 1, icone: 'MoveHorizontal' },
      { pergunta: 'Deve confirmar-se que o sistema de extração está ligado antes de iniciar o trabalho?', opcoes: ['Verdadeiro', 'Falso'], resposta_correta: 0, icone: 'Cog' },
      { pergunta: 'O que fazer se detetares uma avaria no sistema de extração?', opcoes: ['Ignorar e continuar a trabalhar', 'Reportar de imediato ao responsável', 'Desligar tudo e não dizer a ninguém', 'Tentar reparar sozinho sem formação'], resposta_correta: 1, icone: 'PhoneCall' },
    ],
  },
  'Trabalhos a Quente': {
    duracao_horas: 2,
    ...
    conteudo_estruturado: {
      ...
      seccoes: [
        { titulo: 'Introdução', icone: 'Flame', paragrafos: ['Trabalhos a quente — soldadura, corte, esmerilagem — geram faíscas e calor que podem iniciar um incêndio, especialmente em locais com materiais inflamáveis próximos ou fora da vista imediata.'] },
        { titulo: 'Permissão de Trabalho (Permit-to-Work)', icone: 'FileSignature', lista: [
        ...
        { titulo: 'Controlo de Fontes de Ignição', icone: 'Zap', lista: [
        ...
        { titulo: 'Meios de Extinção', icone: 'SprayCan', lista: [
        ...
        { titulo: 'Vigilância Pós-Trabalho', icone: 'Clock', lista: [
    ...
    questionario: [
      { pergunta: 'O que é obrigatório obter antes de iniciar um trabalho a quente num estaleiro?', opcoes: ['Nada, é só começar', 'Uma permissão de trabalho (permit-to-work)', 'Só avisar um colega informalmente', 'Nada em particular'], resposta_correta: 1, icone: 'FileWarning' },
      { pergunta: 'Depois de terminar o trabalho a quente, deve-se:', opcoes: ['Ir embora imediatamente', 'Manter vigilância do local durante um período mínimo (ex: 30 min)', 'Deixar tudo ligado e sair', 'Ignorar o local'], resposta_correta: 1, icone: 'TimerReset' },
      { pergunta: 'O que fazer antes de iniciar, em relação a materiais inflamáveis próximos?', opcoes: ['Nada, não é preciso', 'Afastá-los ou protegê-los a uma distância de segurança', 'Aproximá-los para facilitar o trabalho', 'Cobri-los com papel'], resposta_correta: 1, icone: 'Boxes' },
      { pergunta: 'É necessário confirmar a localização do extintor antes de iniciar um trabalho a quente?', opcoes: ['Verdadeiro', 'Falso'], resposta_correta: 0, icone: 'Flag' },
      { pergunta: 'Um foco de incêndio pode surgir com atraso depois do trabalho terminar?', opcoes: ['Verdadeiro — por isso se mantém vigilância pós-trabalho', 'Falso — o risco desaparece assim que se para de soldar'], resposta_correta: 0, icone: 'Siren' },
    ],
  },
  'Manuseamento de Gases Industriais': {
    duracao_horas: 2,
    ...
    conteudo_estruturado: {
      ...
      seccoes: [
        { titulo: 'Introdução', icone: 'FlaskConical', paragrafos: ['Gases como oxigénio, acetileno e árgon são essenciais ao trabalho de soldadura, mas perigosos se mal manuseados — risco de explosão, asfixia e queimaduras.'] },
        { titulo: 'Identificação de Garrafas', icone: 'Tag', lista: [
        ...
        { titulo: 'Transporte e Armazenamento', icone: 'PackageCheck', lista: [
        ...
        { titulo: 'Deteção de Fugas', icone: 'Droplets', lista: [
        ...
        { titulo: 'Procedimento em Emergência', icone: 'LifeBuoy', lista: [
    ...
    questionario: [
      { pergunta: 'Como se deve transportar uma garrafa de gás?', opcoes: ['Rolando pelo chão', 'Na vertical e presa/fixa', 'Deitada e solta no camião', 'Não importa como'], resposta_correta: 1, icone: 'Cylinder' },
      { pergunta: 'Como se deteta uma fuga de gás numa garrafa?', opcoes: ['Aproximando uma chama', 'Com água e sabão, procurando bolhas', 'Cheirando muito perto e com força', 'Não é possível detetar'], resposta_correta: 1, icone: 'ScanSearch' },
      { pergunta: 'Onde devem ser armazenadas as garrafas de oxigénio?', opcoes: ['Junto de garrafas de gases combustíveis', 'Em local ventilado, afastadas de fontes de calor e de gases incompatíveis', 'Dentro do escritório', 'Não importa onde'], resposta_correta: 1, icone: 'Container' },
      { pergunta: 'Nunca se deve remover ou trocar as etiquetas de identificação das garrafas?', opcoes: ['Verdadeiro', 'Falso'], resposta_correta: 0, icone: 'Tags' },
      { pergunta: 'Se detetares uma fuga, o que deves fazer primeiro?', opcoes: ['Tentar reparar sozinho', 'Afastar-te, isolar a área e acionar o responsável', 'Continuar a trabalhar normalmente', 'Ignorar se for pequena'], resposta_correta: 1, icone: 'UserCheck' },
    ],
  },
