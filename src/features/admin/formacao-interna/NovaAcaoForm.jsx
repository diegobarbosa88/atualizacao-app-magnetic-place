  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      ...
      <button
        type="submit"
        disabled={busy}
        className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl font-black text-xs uppercase tracking-widest text-[var(--navy)] bg-[var(--orange)] hover:bg-[var(--orange-deep)] transition-all disabled:opacity-50"
      >
