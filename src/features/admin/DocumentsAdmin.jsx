                            ...
                            {d.source === 'manual' ? (
                              ...
                              <>
                                <button
                                  ...
                                  className="p-2 bg-white text-slate-600 rounded-xl border border-slate-200 hover:bg-slate-100 transition-all shadow-sm"
                                  title="Pré-visualizar com dados do trabalhador"
                                >
                                  <Eye size={16} />
                                </button>
                                <button
                                  onClick={() => handleDownloadGenerated(d.raw, systemSettings).catch(err => alert('Erro: ' + err.message))}
                                  className="px-2.5 py-2 bg-white text-indigo-700 rounded-xl border border-indigo-100 hover:bg-indigo-50 transition-all shadow-sm inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-widest"
                                ...
                                {d.state === 'awaiting_admin' && (
                                  <button
                                    ...
                                    className="px-3 py-2 bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-sm inline-flex items-center gap-1 disabled:opacity-50"
                                ...
                                {d.signedPdfUrl && (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="px-2.5 py-2 bg-white text-emerald-700 rounded-xl border border-emerald-100 hover:bg-emerald-50 transition-all shadow-sm inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-widest"
