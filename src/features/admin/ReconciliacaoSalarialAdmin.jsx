    ...
    <div className="space-y-5">
      ...
      <div className="flex justify-center">
        <button
          ...
          className="flex items-center gap-2 px-6 py-2.5 rounded-2xl text-[11px] font-black uppercase tracking-widest transition-all bg-[var(--orange)] text-[var(--navy-solid)] hover:bg-[var(--orange-deep)] disabled:opacity-40 disabled:cursor-not-allowed shadow-sm"
        >
