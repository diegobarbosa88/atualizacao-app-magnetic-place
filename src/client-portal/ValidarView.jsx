            ...
            <section className="bg-white rounded-[3rem] shadow-xl border border-slate-100 overflow-hidden">
                <div className="p-8 border-b border-slate-100 bg-slate-50/50 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div>
                        ...
                        <span className={`${SCALE.text.statLabel} text-slate-400 mt-2 block`}>{t('detailed_summary')}</span>
                    </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className={`bg-slate-50 text-slate-400 border-b border-slate-100 ${SCALE.text.statLabel}`}>
                    ...
                    {isApproved ? (
                        <div className="text-center py-6">
                            ...
                            <div className="mt-12 pt-8 border-t border-slate-100 flex flex-col items-center gap-3">
                                <p className={`${SCALE.text.statLabel} text-slate-400`}>{t('editing_disabled')}</p>
                            </div>
                        </div>
                    ) : (
                        <>
                            <div className="text-center mb-10">
                                ...
                                <p className={`text-slate-500 ${SCALE.text.statLabel}`}>{t('sign_to_validate')} {originalTotal} {t('hours_col').toLowerCase()}.</p>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-2xl mx-auto">
                                <button onClick={clearCanvas} className={`w-full sm:w-auto px-6 py-4 text-slate-400 hover:text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 rounded-2xl transition-all ${SCALE.text.badge}`}>{t('clear_canvas')}</button>
