...
- Name: 03-painel-admin\edicao-correcoes.spec.js >> Edição de Correções (Admin) >> BUG: Input deve manter valor digitado pelo admin
- Location: tests\e2e\03-painel-admin\edicao-correcoes.spec.js:147:3
