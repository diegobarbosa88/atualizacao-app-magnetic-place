...
- Name: 03-painel-admin\edicao-correcoes.spec.js >> Edição de Correções (Admin) >> Deve conseguir fazer login como admin
- Location: tests\e2e\03-painel-admin\edicao-correcoes.spec.js:86:3
